...
builtins.brainpi_cache_ram = cache_head_space(
    10
)  # Make available accross all modules as simply calling 'cache_ram'
...
print("Initiating OME Zarr S3 facade")
from ome_zarr_s3 import setup_omezarr_s3

app = setup_omezarr_s3(app, config)
