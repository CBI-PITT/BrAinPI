...
def convert():
    ...
    for t,c in itertools.product(
        ...
        for r in resolutions:
            ...
            batchNumber = 60
            # print(make.shape)
            for ii in list(range(0,make.shape[0]))[::batchNumber]:
                # print(ii)
                start = ii
                stop = ii+batchNumber if ii+batchNumber < make.shape[0] else make.shape[0]
                print('Calling Compute on layers {} to {} of {}'.format(start,
                                                                        stop,
                                                                        make.shape[0]))
