...
class builder:
    ...
    def __init__(
            ...
            sim_jobs=16, compressor=Blosc(cname='zstd', clevel=9, shuffle=hdf5plugin.Blosc.BITSHUFFLE),
            zarr_store_type='H5', chunk_limit_MB=2048, tmp_dir='/CBI_FastStore/tmp_dask', build_imediately = True
            ):
