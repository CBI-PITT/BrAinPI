...
class dataWrapper:
    ...
    def getArray(self,datasetNum,res,key):
        ...
        location = '{}arrayCompress?dset={}&res={}&tstart={}&tstop={}&tstep={}&cstart={}&cstop={}&cstep={}&zstart={}&zstop={}&zstep={}&ystart={}&ystop={}&ystep={}&xstart={}&xstop={}&xstep={}'.format(
        self.baseURL,
        datasetNum,
        res,
    ...
    def get(self,location):
        with urllib.request.urlopen(self.baseURL + location, timeout=5) as url:
